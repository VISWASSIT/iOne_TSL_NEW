...
{
    public partial class frmEmployee_Joining_Data : Form
    {
        DataClasses1DataContext db = new DataClasses1DataContext();
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["iOneConnection"].ConnectionString);
        public frmEmployee_Joining_Data()
        {
            InitializeComponent();
        }
        ...
        private void btnGenerate_Click(object sender, EventArgs e)
        {
            try
            {
                    ...
                    SqlCommand cmd2 = new SqlCommand("SP_HR_Get_Employee_JoinData ", con);
        ...
        private void btnExcell_Click(object sender, EventArgs e)
        {
            ...
            workBook.Worksheets[0].Range["A2"].Value = "Employee Joining Report";
            ...
            workBook.SaveAs(Fname + "\\Employee_Joining_Data.xlsx");
            string doc = Fname + "\\Employee_Joining_Data.xlsx";
