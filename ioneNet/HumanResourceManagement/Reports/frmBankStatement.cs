    ...
    public partial class frmBankStatement : Form
    {
        ...
        private void btnGenerate_Click(object sender, EventArgs e)
        {
            try
            {
                if (logIn.company == 21)
                {
                    SqlCommand cmd2 = new SqlCommand("SP_HR_GetBankStatement_RVPR ", con);
                ...
                {
                    SqlCommand cmd2 = new SqlCommand("SP_HR_GetBankStatement", con);
                    cmd2.CommandType = CommandType.StoredProcedure;
                    cmd2.Parameters.AddWithValue("@compname", logIn.company);
                    cmd2.Parameters.AddWithValue("@strmonth", cmbMonth.Text);
                    cmd2.Parameters.AddWithValue("@strYear", cmbYear.Text);
        ...
        private void btnExcell_Click(object sender, EventArgs e)
        {
            ...
            workBook.Worksheets[0].Range["A2"].Value = "Bank Statement";
            ...
            workBook.SaveAs(Fname + "\\Bank_Statement.xlsx");
            string doc = Fname + "\\Bank_Statement.xlsx";
        ...
        private void sfButton1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    rep = new HumanResourceManagement.Reports.PaySlip_Mars();
