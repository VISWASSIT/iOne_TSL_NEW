...
{
    public partial class frmESI_Report : Form
    {
        ...
        private void btnGenerate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    SqlCommand cmd2 = new SqlCommand("SP_HR_GetESISummary ", con);
                ...
                {
                    SqlCommand cmd2 = new SqlCommand("SP_HR_GetESI_Report ", con);
                    cmd2.CommandType = CommandType.StoredProcedure;
                    cmd2.Parameters.AddWithValue("@compname", logIn.company);
                    cmd2.Parameters.AddWithValue("@strmonth", cmbMonth.Text);
                    cmd2.Parameters.AddWithValue("@strYear", cmbYear.Text);                   
                    ...
                    GridSummaryColumn summaryColumn1 = new GridSummaryColumn();
                    summaryColumn1.Name = "Wages";
                    summaryColumn1.SummaryType = SummaryType.DoubleAggregate;
                    summaryColumn1.Format = "{Sum}";
                    summaryColumn1.MappingName = "Wages";
                    tableSummaryRow1.SummaryColumns.Add(summaryColumn1);
                    this.sfDataGrid1.TableSummaryRows.Add(tableSummaryRow1);
                }
        ...
        private void btnExcell_Click(object sender, EventArgs e)
        {
            ...
            workBook.Worksheets[0].Range["A2"].Value = "ESI REPORT";
            ...
            workBook.SaveAs(Fname + "\\ESI_Report.xlsx");
            string doc = Fname + "\\ESI_Report.xlsx";
