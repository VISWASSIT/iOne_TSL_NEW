...
{
    public partial class frmLeaveAvailedReport : Form
    {
        ...
        private void btnGenerate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //     rep = new MaterialManagement.Transactions.PurchaseOrder();
                    ...
                    rep = new HumanResourceManagement.Reports.Leave_Report();
        ...
        private void frmLeaveAvailedReport_Load(object sender, EventArgs e)
        {
