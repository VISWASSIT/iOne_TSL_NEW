...
{
    public partial class frmPFCriteria : Form
    {
        DataClasses1DataContext db = new DataClasses1DataContext();
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["iOneConnection"].ConnectionString);

        public frmPFCriteria()
        {
            InitializeComponent();
        }
        ...
        public void bindExisitingRecords()
        {
            try
            {
                var p = (from s in db.HR_PF_Criterias
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Employee Contribution Should Not Be Empty", "PF Criteria", MessageBoxButtons.OK, MessageBoxIcon.Information);
                   txtEmpContr.Focus();
                    return;
                }
                ...
                //    {
                //        MessageBox.Show("Select Head Names on Which PF Will be Deducted");
            ...
            {
                MessageBox.Show(ex.Message, "PF Criteria", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        public void save()
        {
            ...
            try
            {
                if (txtID.Text != "")
                {
                    var p1 = db.HR_PF_Criterias.Where(w => w.id == Convert.ToInt32(txtID.Text) && w.Company_ID == logIn.BU_ID).FirstOrDefault();
                ...
                else
                {
                    ...
                    HR_PF_Criteria p = new HR_PF_Criteria();
                    ...
                    db.HR_PF_Criterias.InsertOnSubmit(p);
                    db.SubmitChanges();
                    db.Transaction = transaction;
                    transaction.Commit();
        ...
        private void sfDataGrid1_CellDoubleClick(object sender, Syncfusion.WinForms.DataGrid.Events.CellClickEventArgs e)
        {
            try
            {
                ...
                var d = (from po in db.HR_PF_Criterias
