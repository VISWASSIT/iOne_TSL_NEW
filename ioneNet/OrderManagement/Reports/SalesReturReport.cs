...
{
    public partial class SalesReturReport : Form
    {
        DataClasses1DataContext db = new DataClasses1DataContext();
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["iOneConnection"].ConnectionString);
        
        public SalesReturReport()
        {
            InitializeComponent();
        }
        ...
        public void binddata()
        {
            try
            {
                ...
                SqlCommand cmd2 = new SqlCommand("SP_Report_Sale_Returns", con);
                ...
                summaryColumn2.MappingName = "CGST_AMT";
                ...
                summaryColumn3.MappingName = "SGST_AMT";
        ...
        private void btnExcell_Click(object sender, EventArgs e)
        {
            ...
            workBook.Worksheets[0].Range["A2"].Value = "Sales Return Report";            
            ...
            workBook.SaveAs(Fname + "\\Sales_Return.xlsx");
            string doc = Fname + "\\Sales_Return.xlsx";
