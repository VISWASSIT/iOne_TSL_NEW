...
namespace ioneNet.OrderManagement.Reports
{
    public partial class frmStockStatement_FG : Form
    {
        ...
        private void allotToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            var mappingName1 = sfDataGrid1.Columns["Item_Name"].MappingName;
            var mappingName2 = sfDataGrid1.Columns["Prod_Grade"].MappingName;
            var mappingName3 = sfDataGrid1.Columns["ClosingQty"].MappingName;
        ...
        private void frmStockStatement_FG_Load(object sender, EventArgs e)
        {
        ...
        private void btnExcell_Click(object sender, EventArgs e)
        {
            ...
            {
                workBook.Worksheets[0].Range["A2"].Value = "Stock Statement - FG";
            }
            ...
            {
                workBook.SaveAs(Fname + "\\StockStatement_FG.xlsx");
                doc = Fname + "\\StockStatement_FG.xlsx";
            }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            SqlCommand cmd2 = new SqlCommand("ShowStockReport_FG", con);
                            cmd2.CommandType = CommandType.StoredProcedure;
                            cmd2.Parameters.AddWithValue("@compname", logIn.company);
                            cmd2.Parameters.AddWithValue("@Fromdate", Convert.ToDateTime(dt1));
                            cmd2.Parameters.AddWithValue("@Todate", Convert.ToDateTime(dt2));
