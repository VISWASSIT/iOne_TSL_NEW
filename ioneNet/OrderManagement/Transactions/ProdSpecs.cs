...
{
    public partial class ProdSpecs : Form
    {
            ...
            try
            {
...

                {
                    if (MaterialManagement.Transactions.GoodsReceiptNote.SONo != null && MaterialManagement.Transactions.GoodsReceiptNote.SONo != "OB")
                    {
                        ...
                        textBox3.Text = MaterialManagement.Transactions.GoodsReceiptNote.HeatNo;
                    }
                }
                ...
                {
                    //txtGRN_No.Text = ProductionManagement..DocNo;
                ...
                var dm1 = (from s in db.Bloom_Roll_Wise_Receipts
                           where s.Grn_ID == txtGRN_No.Text && s.SupplierName == textBox3.Text && s.Prod_ID == Convert.ToInt32(txtItem_Code.Text) && s.Company_ID == logIn.company && s.BU_ID == logIn.BU_ID
                           select new
                           {
                               LOT_No = s.RollNo,                               
                               Qty_Kgs = s.RollWt,
            ...
            try
            {
                ...
                //{
                        ...
                        for (int i = 0; i < dgProductsList.RowCount - 1; i++)
                    {
                        ...
                        SC.SupplierName = (textBox3.Text == null) ? "" : (textBox3.Text);
                        if (NewRec==false)
                        { 
                            SC.Status = "Closed";
                        }
                    ...
                    db.SubmitChanges();
                    //transaction.Commit();               
                    MessageBox.Show("Bloom Wise Details Updated Sucessfully");
