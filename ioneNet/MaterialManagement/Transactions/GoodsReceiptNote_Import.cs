...
{
    public partial class GoodsReceiptNote_Import : Form
    {
        ...
        public GoodsReceiptNote_Import()
        {
            InitializeComponent();
        }
        ...
        private void frmNewOrder_Load(object sender, EventArgs e)
        {
            ...
            if(GoodsReceiptNote_Import_List.var=="0")
            {
                if (GoodsReceiptNote_Import_List.editMode == true)
                {
                    bindedit();
                }
            }
        ...
        public void AutoincrementId()
        {
            try
            {
                ...
                var result = db.Sp_autoincrement_GRN_Import(logIn.company, logIn.BU_ID, logIn.fy_Start_Date, logIn.fy_End_Date);
        ...
        public void othercalculation()
        {
            ...
            try
            {
                ...
                txtTot_OrderValue.Text = (rndAmt).ToString(".00");
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dgProducts.Rows.Count > 1)
                {
                    ...
                    dtexisting.Columns.Add("Imported_Price", typeof(decimal));
                    dtexisting.Columns.Add("Imported_Value", typeof(decimal));
                    dtexisting.Columns.Add("Price_INR", typeof(decimal));
                    dtexisting.Columns.Add("Amount_INR", typeof(decimal));                    
                    ...
                    for (int i = 0; i < dgProducts.Rows.Count - 1; i++)
                    {
                        ...
                        dr["Imported_Price"] = dgProducts.Rows[i].Cells["Imported_Price"].Value.ToString();
                        dr["Imported_Value"] = dgProducts.Rows[i].Cells["Imported_Value"].Value.ToString();
                        dr["Price_INR"] = dgProducts.Rows[i].Cells["Price_INR"].Value.ToString();
                        dr["Amount_INR"] = dgProducts.Rows[i].Cells["Amount_INR"].Value.ToString();                            
                ...
                dtgetproducts.Columns.Add("Imported_Price", typeof(decimal));
                dtgetproducts.Columns.Add("Imported_Value", typeof(decimal));
                dtgetproducts.Columns.Add("Price_INR", typeof(decimal));
                dtgetproducts.Columns.Add("Amount_INR", typeof(decimal));               
                    ...
                    foreach (var item in sfDataGrid1.SelectedItems)
                    {
                        ...
                        if (rowData == item)
                        {
                            ...
                            var getHSN = (from s in db.Products     
                                                  where s.Prod_Code == Item_Code.ToString()
                            ...
                            var getTolQty = (from s in db.Purchase_Order_Masters
                                          where s.Id == Convert.ToInt32(Rec_ID)
                                             select new { s.Qty_Tolerence,s.FCurrency,s.ExchangeRate }).FirstOrDefault();
                            exRate = Convert.ToDecimal(getTolQty.ExchangeRate);
                            fc = getTolQty.FCurrency;
                            //if (getHSN != null)
                            ...
                            //var getDiscPer = (from s in db.Purchase_Order_Childs
                            //                 where s.PO_Master_ID == Convert.ToInt32(Rec_ID) && s.Prod_Code == Convert.ToInt32(Item_Code)
                            //                  select new { s.Disc_Per }).FirstOrDefault();

                            DiscPer = Convert.ToDecimal(getDiscPer.Disc_Per);

                            drgetproducts = dtgetproducts.NewRow();
                            drgetproducts["Item_Code"] = getDiscPer.prod_ID.ToString();
                            drgetproducts["Item_Description"] = Item_Description.ToString();
                            drgetproducts["Item_Spec"] = Item_Code.ToString(); 
                            ...
                            drgetproducts["Imported_Price"] = Basic_Price.ToString();
                            drgetproducts["Imported_Value"] = 0;
                            drgetproducts["Price_INR"] = Basic_Price.ToString();
                            drgetproducts["Amount_INR"] =0;
                ...
                txtExchangeRate.Text = exRate.ToString();
                cmbCurrency.Text = fc.ToString();
        ...
        private void cmbPurchaseBasis_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                dgProducts.Columns["Price_INR"].ReadOnly = true;
                dgProducts.Columns["Imported_Price"].ReadOnly = true;
               // dgProducts.Columns["Disc_Per"].ReadOnly = true;
            }
            else
            {
                dgProducts.Columns["Price_INR"].ReadOnly = false;
                dgProducts.Columns["Imported_Price"].ReadOnly = false;
            }
        }
                    ...
                    case "With PR":
                        ...
                        if (dgProducts.Rows.Count > 1)
                        {
                            ...
                            for (int i = 0; i < dgProducts.Rows.Count - 1; i++)
                            {
                                DataRow dr;
                                dr = dtexisting.NewRow();
                                for (int c = 0; c < dgProducts.ColumnCount - 1; c++)
                                {
                        ...
                        if (ioneNet.MaterialManagement.Transactions.frnPRDailog.dtgetproducts.Rows.Count > 0)
                        {
                            ...
                            dt.Columns.Add("PO_Qty", typeof(decimal));
                            dt.Columns.Add("Inv_Qty", typeof(decimal));
                            dt.Columns.Add("Tole_Qty", typeof(decimal));
                            dt.Columns.Add("ReceivedQty", typeof(decimal));
                            dt.Columns.Add("RejectedQty", typeof(decimal));
                            dt.Columns.Add("AcceptedQty", typeof(decimal));
                            dt.Columns.Add("Imported_Price", typeof(decimal));
                            dt.Columns.Add("Imported_Value", typeof(decimal));
                            dt.Columns.Add("Price_INR", typeof(decimal));
                            dt.Columns.Add("Amount_INR", typeof(decimal));
                            ...
                            for (int i = 0; i < ioneNet.MaterialManagement.Transactions.frnPRDailog.dtgetproducts.Rows.Count; i++)
                            {
                                ...
                                dt.Rows.Add(getproducts[0].Item_Code, getproducts[0].Item_Description, getproducts[0].Item_Spec, getproducts[0].Item_Grade, getproducts[0].HSN_Code, getproducts[0].UOM, getproducts[0].PO_Qty,getproducts[0].Inv_Qty, getproducts[0].Tole_Qty, getproducts[0].ReceivedQty, getproducts[0].RejectedQty, getproducts[0].AcceptedQty,getproducts[0].Imported_Price, getproducts[0].Imported_Value, getproducts[0].Price_INR, getproducts[0].Amount_INR, getproducts[0].PO_No, getproducts[0].PR_No, getproducts[0].Heat_No, getproducts[0].TCNo, getproducts[0].Int_Batch_No, getproducts[0].Remarks);
        ...
        private void dgProducts_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                //decimal price = (R1.Cells["Price_INR"].Value == "" || R1.Cells["Price_INR"].Value == DBNull.Value) ? Convert.ToDecimal("00") : Convert.ToDecimal(R1.Cells["Price_INR"].Value);
        ...
        public void Calcaulation()
        {
            ...
            for (int i = 0; i < dgProducts.Rows.Count - 1; i++)
            {
                ...
                //    sgstPer = 0;
                //}
                decimal ConvRate = Convert.ToDecimal(txtExchangeRate.Text);
                
                decimal Imported_Price = (dgProducts.Rows[i].Cells["Imported_Price"].Value == "" || dgProducts.Rows[i].Cells["Imported_Price"].Value == DBNull.Value) ? Convert.ToDecimal("00") : Convert.ToDecimal(dgProducts.Rows[i].Cells["Imported_Price"].Value);
                decimal Price_INR = Imported_Price * ConvRate;
                R1.Cells["Price_INR"].Value = Price_INR.ToString("0.00");
                //decimal Price_INR = (R1.Cells["Price_INR"].Value == "" || R1.Cells["Price_INR"].Value == DBNull.Value) ? Convert.ToDecimal("00") : Convert.ToDecimal(R1.Cells["Price_INR"].Value);

                decimal Amt = acceptedQty * Price_INR;

                R1.Cells["Amount_INR"].Value = Amt.ToString("0.00");
                decimal ImportedAmt = (acceptedQty * Imported_Price);
                R1.Cells["Imported_Value"].Value = ImportedAmt.ToString("0.00");
                ...
                x += (dgProducts.Rows[i].Cells["AcceptedQty"].Value == "" || dgProducts.Rows[i].Cells["AcceptedQty"].Value == null || dgProducts.Rows[i].Cells["AcceptedQty"].Value == DBNull.Value) ? Convert.ToDecimal(0) : Convert.ToDecimal(dgProducts.Rows[i].Cells["AcceptedQty"].Value);
                y += (dgProducts.Rows[i].Cells["Amount_INR"].Value == "" || dgProducts.Rows[i].Cells["Amount_INR"].Value == null || dgProducts.Rows[i].Cells["Amount_INR"].Value == DBNull.Value) ? Convert.ToDecimal(0) : Convert.ToDecimal(dgProducts.Rows[i].Cells["Amount_INR"].Value);
                q += (dgProducts.Rows[i].Cells["Imported_Value"].Value == "" || dgProducts.Rows[i].Cells["Imported_Value"].Value == null || dgProducts.Rows[i].Cells["Imported_Value"].Value == DBNull.Value) ? Convert.ToDecimal(0) : Convert.ToDecimal(dgProducts.Rows[i].Cells["Imported_Value"].Value);
                //v += (dgProducts.Rows[i].Cells["Taxable_Value"].Value == "" || dgProducts.Rows[i].Cells["Taxable_Value"].Value == null || dgProducts.Rows[i].Cells["Taxable_Value"].Value == DBNull.Value) ? Convert.ToDecimal(0) : Convert.ToDecimal(dgProducts.Rows[i].Cells["Taxable_Value"].Value);
                //totA += (dgProducts.Rows[i].Cells["Total_Amount"].Value == "" || dgProducts.Rows[i].Cells["Total_Amount"].Value == null || dgProducts.Rows[i].Cells["Total_Amount"].Value == DBNull.Value) ? Convert.ToDecimal(0) : Convert.ToDecimal(dgProducts.Rows[i].Cells["Total_Amount"].Value);
            ...
            txtTotal_Amt.Text = (y + fAmt + OthAmt+PFAmt).ToString(".00");
            decimal taxvalue = (fAmt + OthAmt+ PFAmt); // Get Amount To calculate GST on Frieght and Others
            ...
            //txttcsAmnt.Text = TcsAmt.ToString(".00");
            decimal rndAmt = (txtRounding.Text == "") ? Convert.ToDecimal("00") : Convert.ToDecimal(txtRounding.Text);
            txtTot_OrderValue.Text = (y+taxvalue + rndAmt).ToString(".00");
            decimal TDSAmt = (txtTDSAmount.Text == "") ? Convert.ToDecimal("00") : Convert.ToDecimal(txtTDSAmount.Text);
            decimal TotVal = Convert.ToDecimal(txtTot_OrderValue.Text);
            txtNetGRNValue.Text = (TotVal - TDSAmt).ToString(".00");
        }
        public void Save()
        {
            try
            {
                ...
                {
                    myString = txtSoNo.Text;
                    db.sp_GRN_Import_Delete(myString, logIn.company,logIn.BU_ID);
                }
                else
                {
                    AutoincrementId();
               ...
               GoodsReceiptNote_Import_Master S = new GoodsReceiptNote_Import_Master();
                {
                    S.GRN_Type = "GRN";
                    S.Grn_NO = myString;
                    ...
                    //S.Tot_TaxableValue = (txtTot_TaxableValue.Text == "") ? Convert.ToDecimal("0") : Convert.ToDecimal(txtTot_TaxableValue.Text);
                     S.Currency = (cmbCurrency.Text == "") ? "" : cmbCurrency.Text;                            
                    ...
                    S.Exchange_Rate = (txtExchangeRate.Text == "") ? Convert.ToDecimal("0") : Convert.ToDecimal(txtExchangeRate.Text);
                     S.Tracking_ID = (txtTrackingID.Text == "") ? "" : txtTrackingID.Text;
                   ...
                   // S.ConsigneeName = Convert.ToInt32(1);
                    ...
                    db.GoodsReceiptNote_Import_Masters.InsertOnSubmit(S);
                    db.SubmitChanges();
                }
                        //db.Transaction = transaction;
                for (int i = 0; i < dgProducts.RowCount - 1; i++)
                {
                    GoodsReceiptNote_Import_Child SC = new GoodsReceiptNote_Import_Child();
                    var d1 = (from a in db.GoodsReceiptNote_Import_Masters where a.Grn_NO == myString && a.isDeleted ==false && a.Company_ID == logIn.company && a.BU_ID == logIn.BU_ID select new { a.Id }).ToList();
                    ...
                    SC.Price = (dgProducts.Rows[i].Cells["Price_INR"].Value == DBNull.Value) ? Convert.ToDecimal("00") : Convert.ToDecimal(dgProducts.Rows[i].Cells["Price_INR"].Value);
                    SC.Amount = (dgProducts.Rows[i].Cells["Amount_INR"].Value == DBNull.Value) ? Convert.ToDecimal("00") : Convert.ToDecimal(dgProducts.Rows[i].Cells["Amount_INR"].Value);
                    SC.Imported_Price = (dgProducts.Rows[i].Cells["Imported_Price"].Value == DBNull.Value) ? Convert.ToDecimal("00") : Convert.ToDecimal(dgProducts.Rows[i].Cells["Imported_Price"].Value);
                    SC.Imported_Amount = (dgProducts.Rows[i].Cells["Imported_Value"].Value == DBNull.Value) ? Convert.ToDecimal("00") : Convert.ToDecimal(dgProducts.Rows[i].Cells["Imported_Value"].Value);
                    ...
                    db.GoodsReceiptNote_Import_Childs.InsertOnSubmit(SC);
                }
                db.SubmitChanges();
                //transaction.Commit();               
        ...
        public void bindedit()
        {
            try
            {
                txtSoNo.Text =GoodsReceiptNote_Import_List.SO_No;
                String myString = "";
                myString = txtSoNo.Text;
                var da = (from obj in db.GoodsReceiptNote_Import_Masters
                ...
                if (da.Count > 0)
                {
                    ...
                    txtTrackingID.Text = da[0].Tracking_ID.ToString();
                    txtExchangeRate.Text = da[0].Exchange_Rate.ToString();
                    cmbCurrency.Text = da[0].Currency.ToString();
                    ...
                    ///*cmb*/TaxClass.SelectedValue = da[0].TAX_Class;
                ...
                var dm1 = (from s in db.GoodsReceiptNote_Import_Childs
                           join g in db.GoodsReceiptNote_Import_Masters on s.GRN_Master_ID equals g.Id
                           join p in db.Products on s.Prod_Code equals p.prod_ID
...

                           {
                               ...
                               s.AcceptedQty,
                               s.Imported_Price,
                               Imported_Value = s.Imported_Amount,
                               Price_INR = s.Price,
                               Amount_INR = s.Amount,                               
                               s.PO_No,
                               s.PR_No,
        ...
        public void gridcalculations()
        {
            try
            {
                ...
                for (int i = 0; i < dgProducts.Rows.Count - 1; i++)
                {
                    ...
                    y += (dgProducts.Rows[i].Cells["Amount_INR"].Value == "" || dgProducts.Rows[i].Cells["Amt_Before_Disc"].Value == null || dgProducts.Rows[i].Cells["Amount_INR"].Value == DBNull.Value) ? Convert.ToDecimal(0) : Convert.ToDecimal(dgProducts.Rows[i].Cells["Amount_INR"].Value);
                    q += (dgProducts.Rows[i].Cells["Imported_Value"].Value == "" || dgProducts.Rows[i].Cells["Imported_Value"].Value == null || dgProducts.Rows[i].Cells["Imported_Value"].Value == DBNull.Value) ? Convert.ToDecimal(0) : Convert.ToDecimal(dgProducts.Rows[i].Cells["Imported_Value"].Value);
                    v += (dgProducts.Rows[i].Cells["Taxable_Value"].Value == "" || dgProducts.Rows[i].Cells["Taxable_Value"].Value == null || dgProducts.Rows[i].Cells["Taxable_Value"].Value == DBNull.Value) ? Convert.ToDecimal(0) : Convert.ToDecimal(dgProducts.Rows[i].Cells["Taxable_Value"].Value);
                   totA += (dgProducts.Rows[i].Cells["Total_Amount"].Value == "" || dgProducts.Rows[i].Cells["Total_Amount"].Value == null || dgProducts.Rows[i].Cells["Total_Amount"].Value == DBNull.Value) ? Convert.ToDecimal(0) : Convert.ToDecimal(dgProducts.Rows[i].Cells["Total_Amount"].Value);
