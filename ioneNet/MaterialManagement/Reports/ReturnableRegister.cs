...
namespace ioneNet.MaterialManagement.Reports
{
    ...
    public partial class ReturnableRegister : Form
    {
        DataClasses1DataContext db = new DataClasses1DataContext();
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["iOneConnection"].ConnectionString);

        public ReturnableRegister()
        {
            InitializeComponent();
        }
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            var d = (from data in db.ReturnableRegister(logIn.company,dtpFrmDate.Value,dtpToDate.Value,logIn.BU_ID) select data).ToList();
            if (d.Count > 0)
            {
            ...
            this.sfDataGrid1.Columns["GateVch_No"].FilterRowEditorType = "TextBox";
            this.sfDataGrid1.Columns["GateVch_No"].ShowFilterRowOptions = false;
            this.sfDataGrid1.Columns["GateVch_No"].FilterRowEditorType = "TextBox";
        ...
        private void btnExcell_Click(object sender, EventArgs e)
        {
            ...
            workBook.Worksheets[0].Range["A2"].Value = "Returnable Register";
            ...
            workBook.SaveAs(Fname + "\\Returnable_Report.xlsx");
            string doc = Fname + "\\Returnable_Report.xlsx";
