...
namespace ioneNet.MaterialManagement.Reports
{
    ...
    public partial class GoodsInwardReport_JW : Form
    {
        DataClasses1DataContext db = new DataClasses1DataContext();
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["iOneConnection"].ConnectionString);

        public GoodsInwardReport_JW()
        {
            InitializeComponent();
        }
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            var d = (from data in db.GoodsInwardRegister_jobWork(logIn.company,dtpFrmDate.Value,dtpToDate.Value,logIn.BU_ID) select data).ToList();
            if (d.Count > 0)
            {
        ...
        private void btnExcell_Click(object sender, EventArgs e)
        {
            ...
            workBook.Worksheets[0].Range["A2"].Value = "Goods Inward Register - Job Work";
            ...
            workBook.SaveAs(Fname + "\\GRN_JW_Report.xlsx");
            string doc = Fname + "\\GRN_JW_Report.xlsx";
