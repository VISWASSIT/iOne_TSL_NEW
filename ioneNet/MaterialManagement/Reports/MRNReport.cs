...
namespace ioneNet.MaterialManagement.Reports
{
    ...
    public partial class MRNReport : Form
    {
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            try
            {
                var d = (from data in db.MRNRegister(logIn.company) select data).ToList();
                if (d.Count > 0)
                {
                ...
                this.sfDataGrid1.Columns["MRN_NO"].FilterRowEditorType = "TextBox";
                this.sfDataGrid1.Columns["MRN_NO"].ShowFilterRowOptions = false;
        ...
        private void GoodsInwardReport_Load(object sender, EventArgs e)
        {
        ...
        private void btnExcell_Click(object sender, EventArgs e)
        {
            ...
            workBook.Worksheets[0].Range["A2"].Value = "Material Inward Register";
            ...
            workBook.SaveAs(Fname + "\\MRN_Report.xlsx");
            string doc = Fname + "\\MRN_Report.xlsx";
