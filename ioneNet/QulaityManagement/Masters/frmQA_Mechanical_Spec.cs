...
{
    public partial class frmQA_Mechanical_Spec : Form
    {
        DataClasses1DataContext db = new DataClasses1DataContext();
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["iOneConnection"].ConnectionString);

        public frmQA_Mechanical_Spec()
        {
            InitializeComponent();
        }
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                db.sp_Delete_Mtrl_test_Specs(Convert.ToInt32(cmbMtrlGrade.SelectedValue), logIn.company, "Mechanical", Convert.ToInt32(txtRevNo.Text));
            }
        ...
        public void addItems(AutoCompleteStringCollection coll)
        {
            try
            {
                ...
                {
                    var Prodname = (from d in db.QA_Test_Parameters where d.Test_Group == "Mechanical" select new { d.Test_Parameter }).ToList();
        ...
        private void cmbMtrlGrade_Leave(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    int grn_id = 0;
                    var da = (from obj in db.sp_Get_QA_Spec_LatestRevData(Convert.ToInt32(cmbMtrlGrade.SelectedValue), "Mechanical")
                    ...
                    var ds = (from obj in db.QA_Mtrl_Grade_Test_Specs
                              ...
                              && obj.Rev_No == Convert.ToInt32(txtRevNo.Text) && a.Test_Group == "Mechanical"
                              select new
                              {
